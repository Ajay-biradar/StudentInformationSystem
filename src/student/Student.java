...
public class Student {
    ...
    public int getMax() {
        ...
        Statement st;
        try {
            st = con.createStatement();  // Corrected method name
    ...
    public void delete(int id){
        int yesOrNo = JOptionPane.showConfirmDialog(null,"Course and score recourd will also be deleted","Student Delete",JOptionPane.OK_CANCEL_OPTION,0);
